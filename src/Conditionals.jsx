...
function ShopCollections() {
  return (
    <div className="relative overflow-hidden bg-white">
      <div className="pb-80 pt-16 sm:pt-24 lg:pt-40">
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            ...
            <p className="mt-4 text-xl text-gray-500">
              This year has witnessed the emergence of numerous ML/AI models
              capable of handling complex computational tasks. This advancement,
              while remarkable, has led to increased stress among humans, as AI
              can now efficiently perform tasks with ease and in less time
            </p>
          </div>
          <div>
            <div className="mt-10">
